...
## 🚫 콘텐츠 작성 금지사항 (CRITICAL)

### 과장된 마케팅 카피 절대 금지

**절대 사용 금지 표현들**:
- "월 X천만원 달성", "시간당 X만원", "일 X백만 MAU" 등 구체적 수익 수치
- "자동화 수익", "월 수익 달성법", "X만원 버는" 등 과장된 수익 표현  
- "완전 자동화", "100% 수익 보장" 등 과도한 확신 표현
- "쉽게 돈 벌기", "누구나 성공" 등 허위 약속 표현

**사용해야 할 올바른 표현**:
- 기술적 내용과 실제 기능에 집중
- "실습 중심", "실제 서비스 구축", "비즈니스 관점" 등 교육적 표현
- 구체적 수익보다는 "수익화 전략", "성장 방법" 등 과정 중심 표현
- 검증되지 않은 수치나 과장된 약속 절대 금지

**바이브코딩 강의 정체성 유지**:
- 실습과 기술 중심의 교육 콘텐츠임을 명시
- 과장 없는 솔직하고 실용적인 내용 지향
