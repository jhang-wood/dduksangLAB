    ...
    try {
      ...
      if (response.ok && result.data) {
        ...
        if (result.data.updated_at) {
          setLastUpdated(
            new Date(result.data.updated_at).toLocaleString("ko-KR"),
          );
        } else {
    ...
    try {
      ...
      if (response.ok) {
        ...
        userNotification.alert(
          result.error || "설정 저장 중 오류가 발생했습니다.",
        );
      }
    } catch (error) {
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-deepBlack-300 rounded-xl border border-metallicGold-900/30 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="text-offWhite-200 font-medium">
                      회원가입 허용
                    </h4>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleArrayFieldChange("allowedFileTypes", e.target.value)
                    }
                    className="w-full px-4 py-3 bg-deepBlack-600 border border-metallicGold-900/30 rounded-lg text-offWhite-200 focus:outline-none focus:ring-2 focus:ring-metallicGold-500"
          ...
          <div className="space-y-6">
            ...
            {/* Quick Actions */}
            <div className="bg-deepBlack-300 rounded-xl border border-metallicGold-900/30 p-6">
              <h3 className="text-lg font-semibold text-offWhite-200 mb-4">
                빠른 작업
              </h3>
