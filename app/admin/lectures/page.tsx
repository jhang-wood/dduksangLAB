      ...
      <div className="border-t border-metallicGold-900/30 p-6 bg-deepBlack-600/50">
        ...
        <div className="mb-6 p-4 bg-deepBlack-900 rounded-lg">
          ...
          <input
            ...
            onChange={(e) =>
              setNewChapter({ ...newChapter, video_url: e.target.value })
            }
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 text-offWhite-500">
              <input
                ...
                onChange={(e) =>
                  setNewChapter({ ...newChapter, is_preview: e.target.checked })
                }
        ...
        <div className="space-y-3">
          {lectureChapters.length === 0 ? (
            <p className="text-offWhite-600 text-center py-4">
              등록된 챕터가 없습니다.
            </p>
          ) : (
            lectureChapters.map((chapter, _index) => (
              <div key={chapter.id} className="p-4 bg-deepBlack-900 rounded-lg">
                ...
                <div className="text-sm text-offWhite-600 mb-2">
                  <span className="mr-4">
                    재생시간: {Math.floor(chapter.duration / 60)}분{" "}
                    {chapter.duration % 60}초
                  </span>
                  {chapter.is_preview && (
              ...
              <div className="p-6">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-offWhite-600 mb-2">
                      {lecture.description}
                    </p>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() =>
                        setExpandedLecture(
                          expandedLecture === lecture.id ? null : lecture.id,
                        )
                      }
                      className="p-2 text-offWhite-600 hover:text-metallicGold-500 transition-colors"
                    >
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          ...
          >
            ...
            <div className="p-6 space-y-6">
              {/* Basic Info */}
              <div className="space-y-4">
                <h3 className="text-lg font-bold text-offWhite-200">
                  기본 정보
                </h3>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          level: e.target.value as keyof typeof levelLabels,
                        })
                      }
                      className="w-full px-4 py-3 bg-deepBlack-600 border border-metallicGold-900/30 rounded-lg text-offWhite-200 focus:outline-none focus:ring-2 focus:ring-metallicGold-500"
                    >
              ...
              <div className="space-y-4">
                ...
                {chapters.map((chapter, index) => (
                  <div
                    key={index}
                    className="p-4 bg-deepBlack-600 rounded-lg space-y-3"
                  >
                    <div className="flex items-center justify-between">
                    ...
                    <label className="flex items-center gap-2 text-offWhite-500">
                      <input
                        ...
                        onChange={(e) =>
                          updateChapter(index, "is_preview", e.target.checked)
                        }
                        className="rounded text-metallicGold-500"
                      />
                      미리보기 가능
