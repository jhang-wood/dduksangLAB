        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-deepBlack-300 rounded-xl border border-metallicGold-900/30 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-offWhite-200">커뮤니티</h3>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-offWhite-600">총 게시글</span>
                <span className="text-offWhite-200 font-semibold">{stats.totalPosts}개</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-deepBlack-300 rounded-xl border border-metallicGold-900/30 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-offWhite-200">사이트 홍보</h3>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-offWhite-600">등록된 사이트</span>
                <span className="text-offWhite-200 font-semibold">{stats.totalSites}개</span>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-deepBlack-300 rounded-xl border border-metallicGold-900/30 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-lg font-semibold text-offWhite-200">매출 분석 (최근 7일)</h3>
            </div>
            <RevenueChart />
          </div>
        </div>
