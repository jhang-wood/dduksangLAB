              ...
              <div className="space-y-8">
                {filteredTrends.map((trend, index) => {
                  ...
                  return (
                    ...
                    >
                      <Link href={`/ai-trends/${trend.slug}`} className="group block">
                        <article className="relative group overflow-hidden bg-gradient-to-br from-deepBlack-300/50 via-deepBlack-400/30 to-deepBlack-500/50 backdrop-blur-sm border border-metallicGold-900/20 rounded-xl hover:border-metallicGold-500/40 hover:shadow-xl hover:shadow-metallicGold-500/5 transition-all duration-400">
                          {/* Glow Effect */}
                          ...
                          <div className="relative flex flex-col sm:flex-row gap-4 p-6">
                            ...
                            <div className="flex-shrink-0 order-1 sm:order-1">
                              <div className="relative w-full h-48 sm:w-32 sm:h-18 md:w-40 md:h-[90px] bg-deepBlack-600/50 rounded-lg overflow-hidden group-hover:scale-105 transition-transform duration-400">
                            ...
                            <div className="flex-1 min-w-0 order-2 sm:order-2">
                              ...
                              <h3 className="text-lg font-bold text-offWhite-200 mb-2 group-hover:text-metallicGold-400 transition-colors line-clamp-2">
                                {trend.title}
                              </h3>
