            ...
            {activeTab === 'dashboard' && (
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  <div
                    className="bg-gradient-to-br from-metallicGold-500/20 to-metallicGold-900/20 border border-metallicGold-500/30 rounded-xl p-6 hover:scale-105 transition-transform"
                  >
                  ...
                  <motion.div
                    ...
                    className="bg-gradient-to-br from-blue-500/20 to-blue-900/20 border border-blue-500/30 rounded-xl p-6"
                  >
                    <div className="flex items-center justify-between mb-4">
                  ...
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    className="bg-gradient-to-br from-yellow-500/20 to-yellow-900/20 border border-yellow-500/30 rounded-xl p-6"
                  >
                    <div className="flex items-center justify-between mb-4">
                  ...
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    className="bg-gradient-to-br from-purple-500/20 to-purple-900/20 border border-purple-500/30 rounded-xl p-6"
                  >
                    <div className="flex items-center justify-between mb-4">
            ...
            {activeTab === 'sites' && (
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <h1 className="text-2xl font-bold text-offWhite-200">내 사이트</h1>
                  <button
                    onClick={() => router.push('/sites/register')}
                ...
                {userSites.length === 0 ? (
                  <div className="bg-deepBlack-300/50 border border-metallicGold-900/30 rounded-xl p-12 text-center">
                    ...
                    <h3 className="text-xl font-bold text-offWhite-200 mb-2">아직 등록한 사이트가 없습니다</h3>
                    <p className="text-offWhite-500 mb-6">지금 사이트를 등록하고 홍보를 시작해보세요!</p>
                    <button
                      onClick={() => router.push('/sites/register')}
                      className="px-6 py-3 bg-gradient-to-r from-metallicGold-500 to-metallicGold-900 text-deepBlack-900 rounded-lg font-bold"
                    >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {userSites.map((site) => (
                      <motion.div
                        ...
                        className="bg-deepBlack-300/50 border border-metallicGold-900/30 rounded-xl p-6"
                      >
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          <div className="text-center p-2 bg-deepBlack-900/30 rounded-lg">
                            ...
                            <p className="text-sm font-bold text-offWhite-200">{site.views_today}</p>
                            <p className="text-xs text-offWhite-500">오늘</p>
                          </div>
                          <div className="text-center p-2 bg-deepBlack-900/30 rounded-lg">
                            <BarChart3 className="w-4 h-4 text-green-400 mx-auto mb-1" />
                            <p className="text-sm font-bold text-offWhite-200">{site.views_total}</p>
                            <p className="text-xs text-offWhite-500">총 조회</p>
                          </div>
                          <div className="text-center p-2 bg-deepBlack-900/30 rounded-lg">
                            <Heart className="w-4 h-4 text-red-400 mx-auto mb-1" />
                            <p className="text-sm font-bold text-offWhite-200">{site.likes}</p>
