        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-metallicGold-500 font-semibold text-lg mb-4">
                {instructor.title}
              </p>
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-2xl font-bold text-offWhite-200 mb-8">
              주요 성과 및 경험
            </h3>
        ...
        >
          <div className="text-center">
            ...
            <blockquote className="text-lg text-offWhite-300 leading-relaxed max-w-4xl mx-auto">
              "저는 여러분과 같은 비개발자였습니다. 코딩을 모르는 상황에서 AI의 힘을 빌려 
              원하는 결과를 만들어내는 방법을 터득했고, 그 과정에서 얻은 노하우를 
              아낌없이 공유하고자 합니다.
              <br /><br />
              복잡한 이론보다는 <strong className="text-metallicGold-500">실제로 써먹을 수 있는 실무 중심</strong>의 
              내용으로 구성했으며, 여러분이 <strong className="text-metallicGold-500">단 한 번의 강의로 
              평생 활용할 수 있는 스킬</strong>을 얻어가시길 바랍니다."
            </blockquote>
  ...
  achievements: [
    {
      icon: TrendingUp,
      title: "월 매출 8자리 달성",
      description: "AI 자동화 도구를 활용해 비개발자임에도 불구하고 안정적인 수익 구조를 만들었습니다.",
      value: "월 1,000만원+"
    },
    {
      icon: Users,
    ...
    },
    {
      icon: Award,
      title: "수강생 만족도 98%",
      description: "실무 중심의 커리큘럼과 1:1 멘토링으로 매우 높은 수강생 만족도를 유지하고 있습니다.",
      value: "98%"
    },
    {
      icon: Target,
      title: "실전 프로젝트 완성률",
      description: "강의를 완주한 수강생 중 95%가 자신만의 자동화 프로그램을 성공적으로 완성했습니다.",
      value: "95%"
    }
  ]
}