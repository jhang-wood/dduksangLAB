      ...
      {stats.map((stat, index) => (
        ...
        >
          <div className="flex items-center gap-4">
            <div
              className={`w-12 h-12 rounded-xl ${stat.bgColor} border border-current/30 flex items-center justify-center ${stat.color}`}
            >
            ...
            <div>
              <div className="flex items-baseline gap-1">
                ...
                {stat.total && <span className="text-offWhite-500 text-sm">/ {stat.total}</span>}
                {stat.unit && <span className="text-offWhite-500 text-sm">{stat.unit}</span>}
              </div>
...
export const SocialProof = ({
  ...
  return (
    <div
      className={`bg-deepBlack-600/50 rounded-2xl p-6 border border-metallicGold-500/20 ${className}`}
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        {/* 평점 */}
        <div className="text-center">
          <div className="flex items-center justify-center gap-1 mb-2">{renderStars(rating)}</div>
        ...
        <div className="text-center">
          ...
          >
            ...
            <span className="text-2xl font-bold text-green-400">{liveStudents}</span>
          </motion.div>
        ...
        <div className="text-center">
          ...
          >
            ...
            <span className="text-2xl font-bold text-metallicGold-500">{completionRate}%</span>
          </motion.div>
  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <div className="text-3xl font-bold text-offWhite-200 mb-2">남은 시간</div>
        {/* 실제 카운트다운 로직은 CountdownTimer 컴포넌트 활용 */}
        <div className="text-red-400 text-sm">기회를 놓치지 마세요!</div>
      </div>
    </motion.div>
  );
};
