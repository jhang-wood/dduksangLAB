  ...
  const mockReviews: Review[] = [
    {
      ...
      content: 'AI Agent를 실제로 구축하면서 배우는 방식이 너무 좋았습니다. 특히 Claude Code 활용법이 인상깊었어요. 이제 업무 자동화가 훨씬 쉬워졌습니다.',
    ...
    },
    {
      ...
      content: '코딩을 전혀 모르는 상태에서 시작했는데, 설명이 너무 친절하고 체계적이에요. 텔레그램으로 프로그램을 만드는 게 정말 신기했습니다.',
    ...
    },
    {
      ...
      content: '내용 자체는 정말 유용하고 최신 트렌드를 잘 반영하고 있어요. 다만 완전 초보에게는 조금 어려울 수 있을 것 같아요. 하지만 충분히 가치있는 투자입니다.',
    ...
    },
    {
      ...
      content: '이번에도 기대를 저버리지 않네요! AI 기술을 이렇게 쉽게 활용할 수 있다니 정말 놀랍습니다. 수강료가 아깝지 않아요.',
      courseId: 'ai-agent-master',
      courseName: 'AI Agent 마스터과정',
      isVerified: true,
      helpfulCount: 31,
    ...
    },
    {
      ...
      rating: 5,
      title: '투자 대비 최고의 수익률',
      content: '30만원이 전혀 아깝지 않습니다. 실제로 회사에서 AI 도구들을 활용해서 업무 효율이 3배는 올라갔어요. 동료들도 모두 놀라고 있습니다.',
      courseId: 'ai-agent-master',
      courseName: 'AI Agent 마스터과정',
      isVerified: false,
      helpfulCount: 29,
